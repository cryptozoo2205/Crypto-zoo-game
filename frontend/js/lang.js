...
CryptoZoo.lang = {
    ...
    translations: {
        en: {
            ...
            allDailyMissionsCompleted: "All daily missions completed",
            nextMissionsLocked: "Next missions locked",
            ...
            expeditionUpgrades: "Expedition Upgrades",
            rareBonus: "Rare bonus",
            epicBonus: "Epic bonus",
            timeBoostsAvailable: "Time boosts available",
            common: "Common",
            rare: "Rare",
            epic: "Epic",
            fromEveryExpedition: "from every expedition",
            ...
            expeditionReward: "expedition reward",
            ...
            boostShopCardCostWrap: "Cost: <strong>3 gems</strong>",
            active24h: "Active 24h",
            cooldown: "Cooldown",
            oncePer24h: "1 time / 24h",
            for24h: "for 24h",

            boostActive: "Boost active",
            needGemBoost: "You need 3 gems for X2 Boost",
            ...
            miniGamesSubtitle: "Play mini games and claim rewards",
            ...
            profileRewardWalletDesc: "",
            profileWithdrawHistory: "Withdraw History",
            transferReward: "Transfer Reward",
            withdrawRequest: "Withdraw Request",

            toggleWithdraw: "Deposit / Withdraw",
            hideWithdraw: "Hide deposit / withdraw",
            ...
            noDepositsHistory: "No deposit history",
            note: "Note",
            ...
            depositCreateError: "Failed to create deposit",

            settingsSubtitle: "Game settings and FAQ",
            faqHelp: "FAQ / Help",
            openFaq: "Open FAQ",

            faqWhatIsGameQ: "🐾 What is Crypto Zoo?",
            faqWhatIsGameA: "Crypto Zoo is a clicker + idle game where you build your zoo, earn coins, complete missions, play mini games, and manage progression.",
            faqHowEarnCoinsQ: "🪙 How do I earn coins?",
            faqHowEarnCoinsA: "You earn coins by tapping, passive zoo income, upgrading animals, completing daily missions, mini games, and expeditions.",
            faqGemsQ: "💎 What are Gems?",
            faqGemsA: "Gems are premium currency used for X2 Boost, expedition reward boosts and expedition time reduction.",
            faqRewardQ: "🎯 What is Reward?",
            faqRewardA: "Reward is a special earning currency. It goes to Reward Balance, then can be transferred to Wallet and withdrawn.",
            faqDailyRewardQ: "🎁 How does Daily Reward work?",
            faqDailyRewardA: "Daily Reward can be claimed every 24 hours. The system includes a 7-day streak for better rewards.",
            faqDailyMissionsQ: "📋 How do Daily Missions work?",
            faqDailyMissionsA: "Each day you get missions. They unlock one by one after claiming the previous one.",
            faqMemoryQ: "🧠 How does Memory work?",
            faqMemoryA: "Match all pairs to win. After completion you receive coins and gems, then cooldown starts.",
            faqExpeditionsQ: "🚀 How do expeditions work?",
            faqExpeditionsA: "Send animals on expeditions. After time you receive coins and additional rewards based on expedition quality.",
            faqBoostQ: "⚡ How does X2 Boost work?",
            faqBoostA: "X2 Boost doubles tap income and zoo income for 10 minutes.",
            faqAnimalsQ: "🦁 How do animals work?",
            faqAnimalsA: "Each animal generates income. More animals and higher levels increase zoo income.",
            faqWalletQ: "🏦 How does Reward Wallet work?",
            faqWalletA: "You can transfer Reward Balance to Wallet. Wallet is used for withdrawals.",
            faqWithdrawQ: "📤 How does withdraw work?",
            faqWithdrawA: "After reaching minimum amount you can create a withdraw request and track its status.",
            faqRefQ: "🤝 How does referral work?",
            faqRefA: "Invite players using your link and earn bonuses based on their activity.",
            ...
            coinPerClickDesc: "coins per click",
            levelAllOwnedAnimals: "levels to all owned animals",
            increaseEpicChance: "Increases Epic reward chance",
            increaseRareChance: "Increases Rare reward chance",
            increaseExpeditionReward: "Increases expedition rewards",
            reduceOneActiveExpedition: "Reduces one active expedition by",
            ...
            shopExpeditionTime3: "Rapid Expedition",
            shopExpeditionTime4: "Mega Expedition",
        ...
        pl: {
            ...
            comingSoon: "🚀 Wkrótce",
            selectedAnimals: "Wybrane zwierzęta",
            ...
            completed: "Ukończone",
            reward: "Nagroda",
            noMissionsToday: "Brak misji na dzisiaj",
            allDailyMissionsCompleted: "Wszystkie misje ukończone",
            nextMissionsLocked: "Kolejne misje zablokowane",
            ...
            time: "Czas",
            rewardWallet: "Reward Wallet",
            rewardQuality: "Jakość nagrody",
            expectedReward: "Przewidywana nagroda",
            unlockLevel: "Wymagany poziom",
            bonusChance: "Szansa na bonus",
            expeditionUpgrades: "Ulepszenia ekspedycji",
            rareBonus: "Bonus Rare",
            epicBonus: "Bonus Epic",
            timeBoostsAvailable: "Dostępne skrócenia czasu",
            common: "Common",
            rare: "Rare",
            epic: "Epic",
            fromEveryExpedition: "z każdej ekspedycji",
            ...
            charges: "Ładunki",
            available: "Dostępne",
            clickBoost: "Boost klików",
            incomeBoost: "Boost dochodu",
            expeditionBoost: "Boost ekspedycji",
            expeditionReward: "reward z ekspedycji",
            timeConsumable: "Skracanie czasu",
            ...
            boostShopCardCostWrap: "Koszt: <strong>3 gemy</strong>",
            active24h: "Aktywny 24h",
            cooldown: "Cooldown",
            oncePer24h: "1 raz / 24h",
            for24h: "na 24h",

            boostActive: "Boost aktywny",
            needGemBoost: "Potrzebujesz 3 gemy na X2 Boost",
            boostActiveShort: "Aktywny",
            activate: "Aktywuj",
            x2Boost: "⚡ X2 Boost",
            boostCenter: "Centrum boostów",
            buyOrActivateX2: "Kup lub aktywuj X2",

            needGem: "Potrzebujesz 1 gema",
            noExpedition: "Brak ekspedycji",
            expeditionRunning: "Ekspedycja jeszcze trwa",
            timeReduced: "Skrócono czas",
            eventsSoon: "Eventy w przygotowaniu",

            offlineEarnings: "Zarobki offline",
            ...
            events: "Eventy",
            miniGames: "🎮 Mini Games",
            miniGamesSubtitle: "Zagraj w minigry i odbierz nagrody",
            ...
            profileAnimals: "Zwierzęta",
            profileSpecies: "Gatunki",
            profileBoxes: "Boxy",
            profileRanking: "Ranking",
            profileReward: "Reward",
            profileWallet: "Wallet",
            profilePending: "Pending",
            profileBoostStatus: "Status boosta",
            profileRewardWalletTitle: "Reward Wallet",
            profileRewardWalletDesc: "",
            profileWithdrawHistory: "Historia wypłat",
            transferReward: "Transfer Reward",
            withdrawRequest: "Withdraw Request",

            toggleWithdraw: "Deposit / Withdraw",
            hideWithdraw: "Ukryj deposit / withdraw",
            ...
            noDepositsHistory: "Brak historii wpłat",
            note: "Notatka",
            ...
            createDeposit: "Stwórz deposit",
            depositCreateError: "Nie udało się utworzyć depositu",

            settingsSubtitle: "Ustawienia gry i FAQ",
            faqHelp: "FAQ / Pomoc",
            openFaq: "Otwórz FAQ",

            faqWhatIsGameQ: "🐾 Czym jest Crypto Zoo?",
            faqWhatIsGameA: "Crypto Zoo to gra clicker + idle, w której rozwijasz swoje zoo, zdobywasz coins, wykonujesz misje, grasz w minigry i zarządzasz rozwojem.",
            faqHowEarnCoinsQ: "🪙 Jak zdobywać coins?",
            faqHowEarnCoinsA: "Coins zdobywasz klikając, z pasywnego dochodu zoo, ulepszając zwierzęta, wykonując misje dzienne, grając w minigry i robiąc ekspedycje.",
            faqGemsQ: "💎 Czym są Gems?",
            faqGemsA: "Gems to waluta premium używana do X2 Boost, boosta rewardu z ekspedycji oraz skracania czasu ekspedycji.",
            faqRewardQ: "🎯 Czym jest Reward?",
            faqRewardA: "Reward to specjalna waluta zarobkowa. Trafia najpierw do Reward Balance, potem możesz ją przenieść do Wallet i wypłacić.",
            faqDailyRewardQ: "🎁 Jak działa Daily Reward?",
            faqDailyRewardA: "Daily Reward można odebrać co 24 godziny. System posiada streak do 7 dni, który zwiększa nagrody.",
            faqDailyMissionsQ: "📋 Jak działają Daily Missions?",
            faqDailyMissionsA: "Każdego dnia dostajesz zestaw misji. Wykonujesz je po kolei — kolejna odblokowuje się dopiero po odebraniu poprzedniej.",
            faqMemoryQ: "🧠 Jak działa Memory?",
            faqMemoryA: "Znajdź wszystkie pary kart. Po ukończeniu dostajesz coins i gems. Następnie uruchamia się cooldown.",
            faqExpeditionsQ: "🚀 Jak działają ekspedycje?",
            faqExpeditionsA: "Wysyłasz zwierzęta na ekspedycje. Po czasie dostajesz coins oraz dodatkowe nagrody zależne od jakości ekspedycji.",
            faqBoostQ: "⚡ Jak działa X2 Boost?",
            faqBoostA: "X2 Boost podwaja dochód z kliknięć oraz zoo na 10 minut.",
            faqAnimalsQ: "🦁 Jak działają zwierzęta?",
            faqAnimalsA: "Każde zwierzę generuje dochód. Im więcej zwierząt i wyższy poziom, tym większy zoo income.",
            faqWalletQ: "🏦 Jak działa Reward Wallet?",
            faqWalletA: "Reward Balance możesz przenieść do Wallet. Wallet służy do tworzenia wypłat.",
            faqWithdrawQ: "📤 Jak działa withdraw?",
            faqWithdrawA: "Po osiągnięciu minimalnej wartości możesz utworzyć withdraw request. Status możesz sprawdzić w historii.",
            faqRefQ: "🤝 Jak działa referral?",
            faqRefA: "Zapraszaj graczy swoim linkiem. Otrzymujesz bonusy za aktywność zaproszonych użytkowników.",
            ...
            coinPerClickDesc: "coin za kliknięcie",
            levelAllOwnedAnimals: "poziomy do wszystkich posiadanych zwierząt",
            increaseEpicChance: "Zwiększa szansę na Epic",
            increaseRareChance: "Zwiększa szansę na Rare",
            increaseExpeditionReward: "Zwiększa nagrody z ekspedycji",
            reduceOneActiveExpedition: "Skraca jedną aktywną ekspedycję o",
            ...
            expeditionGlacier: "Zamarznięty Lodowiec",
            ...
            updateDailyMissions: "🐾 Misje dzienne",
            ...
            updateWithdrawUpgrade: "🏦 Ulepszenie systemu wypłat",
            updateMonthlyReward: "🎁 System nagród miesięcznych"
        }
    },
    ...
    setText(id, key) {
        ...
        if (el) {
            ...
            el.textContent = value !== key ? value : (el.textContent || key);
        }
    },
    ...
    setHtml(id, key) {
        ...
        if (el) {
            const value = this.t(key);
            el.innerHTML = value !== key ? value : (el.innerHTML || key);
        }
    },
    ...
    init() {
        ...
        if (saved && this.translations[saved]) {
            ...
            localStorage.setItem("cz_lang", this.current);
        }
